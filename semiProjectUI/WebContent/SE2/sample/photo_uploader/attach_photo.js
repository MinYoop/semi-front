    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/semiProjectUI/file_uploader_html5.jsp';
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 	    	...
 	    	sUrl : '/semiProjectUI/file_uploader.jsp',
 	    	sCallback : '/semiProjectUI/SE2/sample/photo_uploader/img/callback.html',
