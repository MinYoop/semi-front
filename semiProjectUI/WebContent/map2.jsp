...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=fcce2df2939bca5734fd756caf9ea252&libraries=clusterer"></script>
<script>
 ...
 // HTML5의 geolocation으로 사용할 수 있는지 확인합니다 
    if (navigator.geolocation) {
        ...
        navigator.geolocation.getCurrentPosition(function(position) {
            ...
            var locPosition = new daum.maps.LatLng(lat, lon), // 마커가 표시될 위치를 geolocation으로 얻어온 좌표로 생성합니다
                message = '<a>현재 내 위치  <img src="JSON/이창환.JPG" width="30" height="30"/> </a>'; // 인포윈도우에 표시될 내용입니다
    ...
    $.get("JSON/bike.json", function(data) {
