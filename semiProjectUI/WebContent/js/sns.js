				...
				$.ajax({
					...
					success : function(msg) {
						...
						if (msg > 0) {
							...
							Promise.resolve().then(alert("환영합니다.")).then(
							$("#subscriptionModal").modal('hide'));
					
						} else{
						Promise.resolve().then(alert("회원가입이 필요합니다."))
						.then(Location.href="signin.jsp?snsid="+this.this.sns+id);
