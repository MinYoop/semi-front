            ...
            <div class="col-lg-12 mb-50">
                <div class="d-flex border">
                    <div class="flex-basis-15 p-2 p-sm-4 border-right text-center">
                        <a class="text-gray d-inline-block px-1" href="shop.html"><i class="ti-layout-grid3-alt"></i></a>
                        <a class="text-color d-inline-block px-1" href="shop-list.html"><i class="ti-view-list-alt"></i></a>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="product-thumb position-relative text-center">
                                <div class="overflow-hidden position-relative">
                                    <a href="product-single.html">
                                        <img class="img-fluid w-100 mb-3 img-first" src="images/collection/product-1.jpg"
                                            alt="product-img">
                                        <img class="img-fluid w-100 mb-3 img-second" src="images/collection/product-4.jpg"
                                            alt="product-img">
                                    </a>
                                </div>
                                <div class="product-hover-overlay">
                                    <a href="#" class="product-icon favorite" data-toggle="tooltip" data-placement="left"
                        ...
                        <div class="col-sm-8">
                            <div class="product-info">
                                <h3 class="mb-md-4 mb-3"><a class="text-color" href="product-single.html">Leather Backpack</a></h3>
                                <p class="mb-md-4 mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                                <span class="h4">$320.79</span>
                                <ul class="list-unstyled mt-md-5 mt-3">
                                    <li><a href="#" class="btn btn-dark mb-3 btn-sm">Add To Favorite</a></li>
                                    <li><a href="#" class="btn btn-primary btn-sm">Add To cart</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="product-thumb position-relative text-center">
                                    <div class="overflow-hidden position-relative">
                                        <a href="product-single.html">
                                            <img class="img-fluid w-100 mb-3 img-first" src="images/collection/product-2.jpg"
                                                alt="product-img">
                                            <img class="img-fluid w-100 mb-3 img-second" src="images/collection/product-5.jpg"
                                                alt="product-img">
                                        </a>
                                    </div>
                                    <div class="product-hover-overlay">
                            ...
                            <div class="col-sm-8">
                                <div class="product-info">
                                    <h3 class="mb-md-4 mb-3"><a class="text-color" href="product-single.html">Box Leather Shoulder Bag</a></h3>
                                    <p class="mb-md-4 mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="product-thumb position-relative text-center">
                                    <div class="overflow-hidden position-relative">
                                        <a href="product-single.html">
                                            <img class="img-fluid w-100 mb-3 img-first" src="images/collection/product-3.jpg"
                                                alt="product-img">
                                            <img class="img-fluid w-100 mb-3 img-second" src="images/collection/product-6.jpg"
                                                alt="product-img">
                                        </a>
                                    </div>
                                    <div class="product-hover-overlay">
                            ...
                            <div class="col-sm-8">
                                <div class="product-info">
                                    <h3 class="mb-md-4 mb-3"><a class="text-color" href="product-single.html">Sneaky Leather Sneakers</a></h3>
                                    <p class="mb-md-4 mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
...
<!-- Mirrored from demo.themefisher.com/themefisher/elite-shop/shop-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Nov 2018 12:09:04 GMT -->
</html>