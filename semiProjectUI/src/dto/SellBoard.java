...
public class SellBoard {
    ...
    // 매매위치위도 
    private int tradeLat;

    // 매매위치경도 
    private int tradeLon;
    ...
    public int getTradeLat() {
        return tradeLat;
    }

    public void setTradeLat(int tradeLat) {
        this.tradeLat = tradeLat;
    }

    public int getTradeLon() {
        return tradeLon;
    }

    public void setTradeLon(int tradeLon) {
